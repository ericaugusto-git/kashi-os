...
export const windowsTemplates: WindowType[] = [
    {app: 'file_explorer', appType: 'os', hideInStartMenu: true, icon: 'folder.svg', headerStyles: {background: 'rgb(var(--theme-color))', transition: 'background-color var(--theme-transition-ms) linear'},  componentPath: "@/Folder/Folder"},
