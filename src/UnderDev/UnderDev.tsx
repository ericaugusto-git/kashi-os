...
export default function UnderDev() {
    ...
    return <div style={{backgroundImage: 'url(under_dev.png)'}} className={`backgroundImage ${style.under_dev} `}>
        ...
        Illustration by <a target='_blank' href="https://icons8.com/illustrations/author/JXNrmH40tJdU">Ivan Haidutski</a> from <a target='_blank' href="https://icons8.com/illustrations">Ouch!</a>
        </div>
    </div>
}